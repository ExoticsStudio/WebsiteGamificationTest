...
gdjs.EndGameCode.asyncCallback10629396 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.EndGameCode.asyncCallback10629396(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.EndGameCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10628756);
}
}}
}
