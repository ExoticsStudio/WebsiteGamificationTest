...
gdjs.LoadingCode.asyncCallback10963236 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.LoadingCode.asyncCallback10963236(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback11451412 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(gdjs.randomInRange(1, 1.5)), (runtimeScene) => (gdjs.LoadingCode.asyncCallback11451412(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback10997204 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(gdjs.randomInRange(1, 1.5)), (runtimeScene) => (gdjs.LoadingCode.asyncCallback10997204(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback7239708 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(gdjs.randomInRange(1, 1.5)), (runtimeScene) => (gdjs.LoadingCode.asyncCallback7239708(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback11011708 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.LoadingCode.asyncCallback11011708(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback10801412 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.LoadingCode.asyncCallback10801412(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback10949100 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.LoadingCode.asyncCallback10949100(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.LoadingCode.asyncCallback10784956 = function (runtimeScene, asyncObjectsList) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1.5), (runtimeScene) => (gdjs.LoadingCode.asyncCallback10784956(runtimeScene, asyncObjectsList)));
}
}
