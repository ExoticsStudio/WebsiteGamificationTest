...
gdjs.NotMobileCode.asyncCallback11185284 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.3), (runtimeScene) => (gdjs.NotMobileCode.asyncCallback11185284(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.NotMobileCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(11184964);
}
}}
}
