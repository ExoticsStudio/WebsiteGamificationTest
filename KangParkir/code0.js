...
gdjs.TitleScreenCode.GDGamePausedText2Objects1= [];
...
gdjs.TitleScreenCode.GDPlayButtonObjects3= [];
gdjs.TitleScreenCode.GDPlayButtonObjects4= [];
...
gdjs.TitleScreenCode.GDCurrentURLObjects1= [];
gdjs.TitleScreenCode.GDCurrentURLObjects2= [];
gdjs.TitleScreenCode.GDCurrentURLObjects3= [];
gdjs.TitleScreenCode.GDCurrentURLObjects4= [];
gdjs.TitleScreenCode.GDGetParameterObjects1= [];
gdjs.TitleScreenCode.GDGetParameterObjects2= [];
gdjs.TitleScreenCode.GDGetParameterObjects3= [];
gdjs.TitleScreenCode.GDGetParameterObjects4= [];
gdjs.TitleScreenCode.GDGetParameter2Objects1= [];
...
gdjs.TitleScreenCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13758908);
}
}}
if (gdjs.TitleScreenCode.condition1IsTrue_0.val) {
...
gdjs.copyArray(runtimeScene.getObjects("PlayButton"), gdjs.TitleScreenCode.GDPlayButtonObjects3);
...
{
gdjs.TitleScreenCode.condition1IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.TitleScreenCode.mapOfGDgdjs_46TitleScreenCode_46GDPlayButtonObjects3Objects, runtimeScene, true, false);
}}
if (gdjs.TitleScreenCode.condition1IsTrue_0.val) {
/* Reuse gdjs.TitleScreenCode.GDPlayButtonObjects3 */
{for(var i = 0, len = gdjs.TitleScreenCode.GDPlayButtonObjects3.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDPlayButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Down", 0.13, 0.13, "linear", 100, false, true);
}
}}
...
gdjs.TitleScreenCode.condition0IsTrue_0.val = false;
{
gdjs.TitleScreenCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.TitleScreenCode.mapOfGDgdjs_46TitleScreenCode_46GDPlayButtonObjects3Objects, runtimeScene, true, true);
}if (gdjs.TitleScreenCode.condition0IsTrue_0.val) {
/* Reuse gdjs.TitleScreenCode.GDPlayButtonObjects3 */
{for(var i = 0, len = gdjs.TitleScreenCode.GDPlayButtonObjects3.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDPlayButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Up", 0.15, 0.15, "linear", 100, false, true);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("PlayButton"), gdjs.TitleScreenCode.GDPlayButtonObjects2);

gdjs.TitleScreenCode.condition0IsTrue_0.val = false;
gdjs.TitleScreenCode.condition1IsTrue_0.val = false;
{
gdjs.TitleScreenCode.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.TitleScreenCode.mapOfGDgdjs_46TitleScreenCode_46GDPlayButtonObjects2Objects, runtimeScene, true, false);
}if ( gdjs.TitleScreenCode.condition0IsTrue_0.val ) {
{
gdjs.TitleScreenCode.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
if (gdjs.TitleScreenCode.condition1IsTrue_0.val) {
/* Reuse gdjs.TitleScreenCode.GDPlayButtonObjects2 */
{for(var i = 0, len = gdjs.TitleScreenCode.GDPlayButtonObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDPlayButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Down", 0.13, 0.13, "linear", 100, false, true);
}
}{for(var i = 0, len = gdjs.TitleScreenCode.GDPlayButtonObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDPlayButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Up", 0.15, 0.15, "linear", 100, false, true);
}
}{/* Unknown instruction - skipped. */}{runtimeScene.getGame().getVariables().getFromIndex(1).setNumber(gdjs.random(gdjs.evtTools.variable.getVariableChildCount(runtimeScene.getGame().getVariables().getFromIndex(0)) - 1));
...
gdjs.copyArray(runtimeScene.getObjects("TitleLogo"), gdjs.TitleScreenCode.GDTitleLogoObjects2);
{for(var i = 0, len = gdjs.TitleScreenCode.GDTitleLogoObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDTitleLogoObjects2[i].getBehavior("Tween").addObjectScaleTween("Kecil", 0.18, 0.18, "linear", 1000, false, true);
}
}}
...
gdjs.TitleScreenCode.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.TitleScreenCode.GDTitleLogoObjects2.length;i<l;++i) {
    if ( gdjs.TitleScreenCode.GDTitleLogoObjects2[i].getBehavior("Tween").hasFinished("Kecil") ) {
        gdjs.TitleScreenCode.condition0IsTrue_0.val = true;
        gdjs.TitleScreenCode.GDTitleLogoObjects2[k] = gdjs.TitleScreenCode.GDTitleLogoObjects2[i];
        ++k;
    }
}
...
{
{gdjs.TitleScreenCode.conditionTrue_1 = gdjs.TitleScreenCode.condition1IsTrue_0;
gdjs.TitleScreenCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13780156);
}
}}
if (gdjs.TitleScreenCode.condition1IsTrue_0.val) {
/* Reuse gdjs.TitleScreenCode.GDTitleLogoObjects2 */
{for(var i = 0, len = gdjs.TitleScreenCode.GDTitleLogoObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDTitleLogoObjects2[i].getBehavior("Tween").addObjectScaleTween("Besar", 0.20, 0.20, "linear", 1000, false, true);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("TitleLogo"), gdjs.TitleScreenCode.GDTitleLogoObjects1);

gdjs.TitleScreenCode.condition0IsTrue_0.val = false;
gdjs.TitleScreenCode.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.TitleScreenCode.GDTitleLogoObjects1.length;i<l;++i) {
    if ( gdjs.TitleScreenCode.GDTitleLogoObjects1[i].getBehavior("Tween").hasFinished("Besar") ) {
        gdjs.TitleScreenCode.condition0IsTrue_0.val = true;
        gdjs.TitleScreenCode.GDTitleLogoObjects1[k] = gdjs.TitleScreenCode.GDTitleLogoObjects1[i];
        ++k;
    }
}
...
{
{gdjs.TitleScreenCode.conditionTrue_1 = gdjs.TitleScreenCode.condition1IsTrue_0;
gdjs.TitleScreenCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13781148);
}
}}
if (gdjs.TitleScreenCode.condition1IsTrue_0.val) {
/* Reuse gdjs.TitleScreenCode.GDTitleLogoObjects1 */
{for(var i = 0, len = gdjs.TitleScreenCode.GDTitleLogoObjects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDTitleLogoObjects1[i].getBehavior("Tween").addObjectScaleTween("Kecil", 0.18, 0.18, "linear", 1000, false, true);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Car"), gdjs.TitleScreenCode.GDCarObjects2);
{for(var i = 0, len = gdjs.TitleScreenCode.GDCarObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDCarObjects2[i].setAnimationFrame(gdjs.randomInRange(0, 8));
}
}{for(var i = 0, len = gdjs.TitleScreenCode.GDCarObjects2.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDCarObjects2[i].pauseAnimation();
}
}}
...
{
gdjs.copyArray(runtimeScene.getObjects("CurrentURL"), gdjs.TitleScreenCode.GDCurrentURLObjects1);
gdjs.copyArray(runtimeScene.getObjects("GetParameter"), gdjs.TitleScreenCode.GDGetParameterObjects1);
gdjs.copyArray(runtimeScene.getObjects("GetParameter2"), gdjs.TitleScreenCode.GDGetParameter2Objects1);
{for(var i = 0, len = gdjs.TitleScreenCode.GDCurrentURLObjects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDCurrentURLObjects1[i].setString("Current URL = " + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("CurrentURL")));
}
}{for(var i = 0, len = gdjs.TitleScreenCode.GDGetParameterObjects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDGetParameterObjects1[i].setString("CustomerID = " + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("Param_CustomerID")));
}
}{for(var i = 0, len = gdjs.TitleScreenCode.GDGetParameter2Objects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDGetParameter2Objects1[i].setString("Username = " + gdjs.evtTools.variable.getVariableString(runtimeScene.getGame().getVariables().get("Param_UsernameID")));
}
}}
...
{
gdjs.copyArray(runtimeScene.getObjects("NewTiledSprite"), gdjs.TitleScreenCode.GDNewTiledSpriteObjects1);
gdjs.copyArray(runtimeScene.getObjects("Obstacle"), gdjs.TitleScreenCode.GDObstacleObjects1);
{for(var i = 0, len = gdjs.TitleScreenCode.GDObstacleObjects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDObstacleObjects1[i].setXOffset(gdjs.TitleScreenCode.GDObstacleObjects1[i].getXOffset() - (1));
}
}{for(var i = 0, len = gdjs.TitleScreenCode.GDNewTiledSpriteObjects1.length ;i < len;++i) {
    gdjs.TitleScreenCode.GDNewTiledSpriteObjects1[i].setYOffset(gdjs.TitleScreenCode.GDNewTiledSpriteObjects1[i].getYOffset() + (1));
}
}}
...
gdjs.TitleScreenCode.GDGamePausedText2Objects1.length = 0;
...
gdjs.TitleScreenCode.GDPlayButtonObjects3.length = 0;
gdjs.TitleScreenCode.GDPlayButtonObjects4.length = 0;
...
gdjs.TitleScreenCode.GDCurrentURLObjects1.length = 0;
gdjs.TitleScreenCode.GDCurrentURLObjects2.length = 0;
gdjs.TitleScreenCode.GDCurrentURLObjects3.length = 0;
gdjs.TitleScreenCode.GDCurrentURLObjects4.length = 0;
gdjs.TitleScreenCode.GDGetParameterObjects1.length = 0;
gdjs.TitleScreenCode.GDGetParameterObjects2.length = 0;
gdjs.TitleScreenCode.GDGetParameterObjects3.length = 0;
gdjs.TitleScreenCode.GDGetParameterObjects4.length = 0;
gdjs.TitleScreenCode.GDGetParameter2Objects1.length = 0;
