...
gdjs.Stage3Code.GDTutorialTextObjects1= [];
gdjs.Stage3Code.GDTutorialTextObjects2= [];
gdjs.Stage3Code.GDTutorialTextObjects3= [];
gdjs.Stage3Code.GDTutorialTextObjects4= [];
gdjs.Stage3Code.GDTutorialTextObjects5= [];
gdjs.Stage3Code.GDGamePausedText2Objects1= [];
gdjs.Stage3Code.GDGamePausedText2Objects2= [];
gdjs.Stage3Code.GDGamePausedText2Objects3= [];
gdjs.Stage3Code.GDGamePausedText2Objects4= [];
gdjs.Stage3Code.GDGamePausedText2Objects5= [];
...
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDGamePausedText2Objects2Objects = Hashtable.newFrom({"GamePausedText2": gdjs.Stage3Code.GDGamePausedText2Objects2});
...
gdjs.Stage3Code.GDGamePausedText2Objects2.length = 0;
...
}{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDGamePausedText2Objects2Objects, (( gdjs.Stage3Code.GDGrassBGObjects2.length === 0 ) ? 0 :gdjs.Stage3Code.GDGrassBGObjects2[0].getWidth()) / 2 - 121, (( gdjs.Stage3Code.GDGrassBGObjects2.length === 0 ) ? 0 :gdjs.Stage3Code.GDGrassBGObjects2[0].getHeight()) / 4, "");
...
for(var i = 0, len = gdjs.Stage3Code.GDGamePausedText2Objects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDGamePausedText2Objects2[i].hide();
}
}}
...
};gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDTutorialTextObjects1Objects = Hashtable.newFrom({"TutorialText": gdjs.Stage3Code.GDTutorialTextObjects1});
...
gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getGame().getVariables().getFromIndex(4), true);
}if (gdjs.Stage3Code.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("GrassBG"), gdjs.Stage3Code.GDGrassBGObjects1);
gdjs.Stage3Code.GDTutorialTextObjects1.length = 0;

{gdjs.evtTools.object.createObjectOnScene((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : runtimeScene), gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDTutorialTextObjects1Objects, (( gdjs.Stage3Code.GDGrassBGObjects1.length === 0 ) ? 0 :gdjs.Stage3Code.GDGrassBGObjects1[0].getWidth()) / 2 - (249 / 2), (( gdjs.Stage3Code.GDGrassBGObjects1.length === 0 ) ? 0 :gdjs.Stage3Code.GDGrassBGObjects1[0].getHeight()) / 2 - (270 / 2), "");
}}
...
{ //Subevents
gdjs.Stage3Code.eventsList9(runtimeScene);} //End of subevents
}
...
{ //Subevents
gdjs.Stage3Code.eventsList12(runtimeScene);} //End of subevents
}
...
gdjs.copyArray(runtimeScene.getObjects("Loading"), gdjs.Stage3Code.GDLoadingObjects3);

gdjs.Stage3Code.condition0IsTrue_0.val = false;
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDLoadingObjects3.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDLoadingObjects3[i].getBehavior("Tween").hasFinished("LoadingOut") ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDLoadingObjects3[k] = gdjs.Stage3Code.GDLoadingObjects3[i];
        ++k;
    }
}
gdjs.Stage3Code.GDLoadingObjects3.length = k;}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(140648020);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.Stage3Code.GDCarObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDCarObjects3[i].activateBehavior("DraggablePhysics", true);
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(140714892);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("Car"), gdjs.Stage3Code.GDCarObjects2);
...
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}if ( gdjs.Stage3Code.condition1IsTrue_0.val ) {
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition2IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(140639252);
}
}}
}
...
{ //Subevents
gdjs.Stage3Code.eventsList14(runtimeScene);} //End of subevents
}
...
gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.variable.getVariableBoolean(runtimeScene.getGame().getVariables().getFromIndex(4), false);
}if (gdjs.Stage3Code.condition0IsTrue_0.val) {
...
{ //Subevents
gdjs.Stage3Code.eventsList19(runtimeScene);} //End of subevents
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141195228);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDCarObjects2 */
...
{ //Subevents
gdjs.Stage3Code.eventsList21(runtimeScene);} //End of subevents
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition2IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141202188);
}
}}
}
if (gdjs.Stage3Code.condition2IsTrue_0.val) {
...
{
gdjs.copyArray(runtimeScene.getObjects("Car"), gdjs.Stage3Code.GDCarObjects3);
gdjs.copyArray(runtimeScene.getObjects("GamePausedText2"), gdjs.Stage3Code.GDGamePausedText2Objects3);
...
for(var i = 0, len = gdjs.Stage3Code.GDGamePausedText2Objects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDGamePausedText2Objects3[i].hide(false);
}
}{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length ;i < len;++i) {
...
};gdjs.Stage3Code.asyncCallback141238428 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Stage3Code.asyncCallback141238428(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141237716);
}
}}
}
}
...
for(var i = 0, len = gdjs.Stage3Code.GDGamePausedText2Objects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDGamePausedText2Objects3[i].hide();
}
}{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length ;i < len;++i) {
...
};gdjs.Stage3Code.asyncCallback141306652 = function (runtimeScene, asyncObjectsList) {
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
for (const obj of gdjs.Stage3Code.GDPauseResumeButtonObjects2) asyncObjectsList.addObject("PauseResumeButton", obj);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Stage3Code.asyncCallback141306652(runtimeScene, asyncObjectsList)));
}
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition3IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141303908);
}
}}
}
}
...
gdjs.Stage3Code.eventsList31 = function(runtimeScene, asyncObjectsList) {
...
};gdjs.Stage3Code.asyncCallback141400540 = function (runtimeScene, asyncObjectsList) {

{ //Subevents
gdjs.Stage3Code.eventsList31(runtimeScene, asyncObjectsList);} //End of subevents
}
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.1), (runtimeScene) => (gdjs.Stage3Code.asyncCallback141400540(runtimeScene, asyncObjectsList)));
}
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition3IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141379364);
}
}}
}
}
...
{ //Subevents
gdjs.Stage3Code.eventsList32(runtimeScene);} //End of subevents
}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141416868);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141592964);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
...
gdjs.Stage3Code.eventsList38 = function(runtimeScene) {
...
gdjs.copyArray(runtimeScene.getObjects("Loading"), gdjs.Stage3Code.GDLoadingObjects3);
{for(var i = 0, len = gdjs.Stage3Code.GDLoadingObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDLoadingObjects3[i].getBehavior("Tween").addObjectOpacityTween("LoadingOut", 0, "easeInQuad", 750, false);
}
}}
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141698436);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("Loading"), gdjs.Stage3Code.GDLoadingObjects3);
{gdjs.evtTools.runtimeScene.pauseTimer(runtimeScene, "SecondsTimer");
    ...
    gdjs.Stage3Code.GDLoadingObjects3[i].getBehavior("Tween").addObjectOpacityTween("LoadingIn", 255, "easeInQuad", 750, false);
}
}}
...
};gdjs.Stage3Code.eventsList39 = function(runtimeScene) {
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141719332);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("TutorialText"), gdjs.Stage3Code.GDTutorialTextObjects3);
{for(var i = 0, len = gdjs.Stage3Code.GDTutorialTextObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDTutorialTextObjects3[i].getBehavior("Tween").addObjectOpacityTween("TutorialOut", 100, "easeInQuad", 500, false);
}
}}
...
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDTutorialTextObjects3.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDTutorialTextObjects3[i].getBehavior("Tween").hasFinished("TutorialOut") ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDTutorialTextObjects3[k] = gdjs.Stage3Code.GDTutorialTextObjects3[i];
        ++k;
    }
}
gdjs.Stage3Code.GDTutorialTextObjects3.length = k;}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141729164);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDTutorialTextObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDTutorialTextObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDTutorialTextObjects3[i].getBehavior("Tween").addObjectOpacityTween("TutorialIn", 255, "easeInQuad", 500, false);
}
}}
...
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDTutorialTextObjects3.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDTutorialTextObjects3[i].getBehavior("Tween").hasFinished("TutorialIn") ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDTutorialTextObjects3[k] = gdjs.Stage3Code.GDTutorialTextObjects3[i];
        ++k;
    }
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141724284);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDTutorialTextObjects3 */
...
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141744460);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("TutorialText"), gdjs.Stage3Code.GDTutorialTextObjects2);
{for(var i = 0, len = gdjs.Stage3Code.GDTutorialTextObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDTutorialTextObjects2[i].deleteFromScene(runtimeScene);
}
}}
...
};gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects3Objects = Hashtable.newFrom({"HomeButton": gdjs.Stage3Code.GDHomeButtonObjects3});
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects3Objects = Hashtable.newFrom({"HomeButton": gdjs.Stage3Code.GDHomeButtonObjects3});
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects2Objects = Hashtable.newFrom({"HomeButton": gdjs.Stage3Code.GDHomeButtonObjects2});
gdjs.Stage3Code.asyncCallback141815932 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "TitleScreen", false);
}}
gdjs.Stage3Code.eventsList40 = function(runtimeScene) {
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(0.25), (runtimeScene) => (gdjs.Stage3Code.asyncCallback141815932(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Stage3Code.eventsList41 = function(runtimeScene) {
...
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.isMouseButtonPressed(runtimeScene, "Left");
}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects3Objects, runtimeScene, true, false);
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDHomeButtonObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDHomeButtonObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDHomeButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Down", 0.11, 0.11, "linear", 100, false, true);
}
}}
...
gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects3Objects, runtimeScene, true, true);
}if (gdjs.Stage3Code.condition0IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDHomeButtonObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDHomeButtonObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDHomeButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Up", 0.13, 0.13, "linear", 100, false, true);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("HomeButton"), gdjs.Stage3Code.GDHomeButtonObjects2);

gdjs.Stage3Code.condition0IsTrue_0.val = false;
gdjs.Stage3Code.condition1IsTrue_0.val = false;
gdjs.Stage3Code.condition2IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDHomeButtonObjects2Objects, runtimeScene, true, false);
}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}if ( gdjs.Stage3Code.condition1IsTrue_0.val ) {
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDHomeButtonObjects2.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDHomeButtonObjects2[i].isVisible() ) {
        gdjs.Stage3Code.condition2IsTrue_0.val = true;
        gdjs.Stage3Code.GDHomeButtonObjects2[k] = gdjs.Stage3Code.GDHomeButtonObjects2[i];
        ++k;
    }
}
gdjs.Stage3Code.GDHomeButtonObjects2.length = k;}}
}
if (gdjs.Stage3Code.condition2IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDHomeButtonObjects2 */
{for(var i = 0, len = gdjs.Stage3Code.GDHomeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDHomeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Down", 0.11, 0.11, "linear", 100, false, true);
}
}{for(var i = 0, len = gdjs.Stage3Code.GDHomeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDHomeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Up", 0.13, 0.13, "linear", 100, false, true);
}
}
{ //Subevents
gdjs.Stage3Code.eventsList40(runtimeScene);} //End of subevents
}

}


};gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects3Objects = Hashtable.newFrom({"PauseResumeButton": gdjs.Stage3Code.GDPauseResumeButtonObjects3});
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects3Objects = Hashtable.newFrom({"PauseResumeButton": gdjs.Stage3Code.GDPauseResumeButtonObjects3});
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects2Objects = Hashtable.newFrom({"PauseResumeButton": gdjs.Stage3Code.GDPauseResumeButtonObjects2});
gdjs.Stage3Code.eventsList42 = function(runtimeScene) {

{

gdjs.copyArray(gdjs.Stage3Code.GDPauseResumeButtonObjects2, gdjs.Stage3Code.GDPauseResumeButtonObjects3);


gdjs.Stage3Code.condition0IsTrue_0.val = false;
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDPauseResumeButtonObjects3[i].getAnimation() == 0 ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDPauseResumeButtonObjects3[k] = gdjs.Stage3Code.GDPauseResumeButtonObjects3[i];
        ++k;
    }
}
gdjs.Stage3Code.GDPauseResumeButtonObjects3.length = k;}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141844684);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects3[i].setScale(0.075);
}
}}
...
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects3Objects, runtimeScene, true, false);
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Down", 0.065, 0.065, "linear", 100, false, true);
}
}}
...
gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects3Objects, runtimeScene, true, true);
}if (gdjs.Stage3Code.condition0IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects3 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects3.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects3[i].getBehavior("Tween").addObjectScaleTween("Up", 0.075, 0.075, "linear", 100, false, true);
}
}}
...
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects2 */
...
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects2 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Down", 0.065, 0.065, "linear", 100, false, true);
}
}{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Up", 0.075, 0.075, "linear", 100, false, true);
}
}}
...
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects2Objects = Hashtable.newFrom({"PauseResumeButton": gdjs.Stage3Code.GDPauseResumeButtonObjects2});
gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects1Objects = Hashtable.newFrom({"PauseResumeButton": gdjs.Stage3Code.GDPauseResumeButtonObjects1});
gdjs.Stage3Code.eventsList43 = function(runtimeScene) {

{

gdjs.copyArray(gdjs.Stage3Code.GDPauseResumeButtonObjects1, gdjs.Stage3Code.GDPauseResumeButtonObjects2);


gdjs.Stage3Code.condition0IsTrue_0.val = false;
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getAnimation() == 1 ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDPauseResumeButtonObjects2[k] = gdjs.Stage3Code.GDPauseResumeButtonObjects2[i];
        ++k;
    }
}
gdjs.Stage3Code.GDPauseResumeButtonObjects2.length = k;}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
{gdjs.Stage3Code.conditionTrue_1 = gdjs.Stage3Code.condition1IsTrue_0;
gdjs.Stage3Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(141928004);
}
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects2 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].setScale(0.125);
}
}}
...
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects2Objects, runtimeScene, true, false);
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects2 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Down", 0.105, 0.105, "linear", 100, false, true);
}
}}
...
gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects2Objects, runtimeScene, true, true);
}if (gdjs.Stage3Code.condition0IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects2 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Up", 0.125, 0.125, "linear", 100, false, true);
}
}}
...
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects1 */

gdjs.Stage3Code.condition0IsTrue_0.val = false;
gdjs.Stage3Code.condition1IsTrue_0.val = false;
{
gdjs.Stage3Code.condition0IsTrue_0.val = gdjs.evtTools.input.cursorOnObject(gdjs.Stage3Code.mapOfGDgdjs_46Stage3Code_46GDPauseResumeButtonObjects1Objects, runtimeScene, true, false);
}if ( gdjs.Stage3Code.condition0IsTrue_0.val ) {
{
gdjs.Stage3Code.condition1IsTrue_0.val = gdjs.evtTools.input.isMouseButtonReleased(runtimeScene, "Left");
}}
if (gdjs.Stage3Code.condition1IsTrue_0.val) {
/* Reuse gdjs.Stage3Code.GDPauseResumeButtonObjects1 */
{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects1.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects1[i].getBehavior("Tween").addObjectScaleTween("Down", 0.105, 0.105, "linear", 100, false, true);
}
}{for(var i = 0, len = gdjs.Stage3Code.GDPauseResumeButtonObjects1.length ;i < len;++i) {
    gdjs.Stage3Code.GDPauseResumeButtonObjects1[i].getBehavior("Tween").addObjectScaleTween("Up", 0.125, 0.125, "linear", 100, false, true);
}
}}
...
};gdjs.Stage3Code.eventsList44 = function(runtimeScene) {
...
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDPauseResumeButtonObjects2.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDPauseResumeButtonObjects2[i].getAnimation() == 0 ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDPauseResumeButtonObjects2[k] = gdjs.Stage3Code.GDPauseResumeButtonObjects2[i];
        ++k;
    }
...
{ //Subevents
gdjs.Stage3Code.eventsList42(runtimeScene);} //End of subevents
}
...
gdjs.copyArray(runtimeScene.getObjects("PauseResumeButton"), gdjs.Stage3Code.GDPauseResumeButtonObjects1);

gdjs.Stage3Code.condition0IsTrue_0.val = false;
{
for(var i = 0, k = 0, l = gdjs.Stage3Code.GDPauseResumeButtonObjects1.length;i<l;++i) {
    if ( gdjs.Stage3Code.GDPauseResumeButtonObjects1[i].getAnimation() == 1 ) {
        gdjs.Stage3Code.condition0IsTrue_0.val = true;
        gdjs.Stage3Code.GDPauseResumeButtonObjects1[k] = gdjs.Stage3Code.GDPauseResumeButtonObjects1[i];
        ++k;
    }
}
gdjs.Stage3Code.GDPauseResumeButtonObjects1.length = k;}if (gdjs.Stage3Code.condition0IsTrue_0.val) {

{ //Subevents
gdjs.Stage3Code.eventsList43(runtimeScene);} //End of subevents
}

}


};gdjs.Stage3Code.eventsList45 = function(runtimeScene) {

{


gdjs.Stage3Code.eventsList41(runtimeScene);
}
...
gdjs.Stage3Code.eventsList44(runtimeScene);
}


};gdjs.Stage3Code.eventsList46 = function(runtimeScene) {
...
gdjs.Stage3Code.eventsList38(runtimeScene);
}
...
gdjs.Stage3Code.eventsList39(runtimeScene);
}
...
gdjs.Stage3Code.eventsList45(runtimeScene);
}


};gdjs.Stage3Code.eventsList47 = function(runtimeScene) {
...
gdjs.Stage3Code.eventsList46(runtimeScene);
}
...
gdjs.Stage3Code.GDTutorialTextObjects1.length = 0;
gdjs.Stage3Code.GDTutorialTextObjects2.length = 0;
gdjs.Stage3Code.GDTutorialTextObjects3.length = 0;
gdjs.Stage3Code.GDTutorialTextObjects4.length = 0;
gdjs.Stage3Code.GDTutorialTextObjects5.length = 0;
gdjs.Stage3Code.GDGamePausedText2Objects1.length = 0;
gdjs.Stage3Code.GDGamePausedText2Objects2.length = 0;
gdjs.Stage3Code.GDGamePausedText2Objects3.length = 0;
gdjs.Stage3Code.GDGamePausedText2Objects4.length = 0;
gdjs.Stage3Code.GDGamePausedText2Objects5.length = 0;
...
gdjs.Stage3Code.eventsList47(runtimeScene);
return;
